 ...
 *
 *  Name: Yoojin Lee   Student ID: 188162218    Date: Feb 16, 2024
 *
 ********************************************************************************/
...
export default function Home() {
  ...
  const { data, error } = useSWR(`https://pear-wandering-harp-seal.cyclic.app/api/listings?page=${page}&perPage=10`);
